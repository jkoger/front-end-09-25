...
interface ConfirmationModal2Interface {
  deleteItem : () => void, 
  subject: string, 
  ref: any
}

export interface ConfirmationModal2Type {
  handleShow: ()=> void, 
  handleClose: ()=> void
}

const  ConfirmationModal2 = ({deleteItem, subject, ref} : ConfirmationModal2Interface) => {
